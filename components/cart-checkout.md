...
Payment adapters are registered via `window.MahoStorefront.registerPaymentAdapter()` and loaded as standalone plugin scripts. See [Payment Methods](/reference/payment-methods) for details.
